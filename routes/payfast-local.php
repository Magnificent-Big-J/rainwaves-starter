...
// loaded when the app is booted in the local/testing environment AND the billing
// module is enabled (see App\Providers\Modules\BillingServiceProvider) — it must
// never be reachable in staging or production. Controller actions additionally
// self-check the environment as defense in depth.
