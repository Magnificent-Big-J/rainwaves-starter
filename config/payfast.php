...
return [
    'merchant_id' => env('PAYFAST_MERCHANT_ID', env('MERCHANT_ID', '10004002')),
    'merchant_key' => env('PAYFAST_MERCHANT_KEY', env('MERCHANT_KEY', 'q1cd2rdny4a53')),
    ...
    'pass_phrase' => env('PAYFAST_PASS_PHRASE', env('PASS_PHRASE', 'payfast')),
];
